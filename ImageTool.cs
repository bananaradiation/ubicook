...
namespace XnaFan.ImageComparison
{
    ...
    public static class ImageTool
    {
        ...
        public static float PercentageDifference1(this Image img1, Image img2, byte threshold = 3)
        {
            byte[,] differences = img1.GetDifferences1(img2);
        ...
        public static byte[,] GetDifferences1(this Image img1, Image img2)
        {
            Bitmap thisOne = (Bitmap)img1.Resize1(16, 16).GetGrayScaleVersion1();
            Bitmap theOtherOne = (Bitmap)img2.Resize1(16, 16).GetGrayScaleVersion1();
        ...
        public static Image GetGrayScaleVersion1(this Image original)
        {
            //http://www.switchonthecode.com/tutorials/csharp-tutorial-convert-a-color-image-to-grayscale
        ...
        public static Image Resize1(this Image originalImage, int newWidth, int newHeight)
        {
        ...
        /// <param name="threshold">How big a difference (out of 255) will be ignored - the default is 3.</param>
        /// <returns>The difference between the two images as a percentage</returns>
        public static float GetPercentageDifference1(string image1Path, string image2Path, byte threshold = 3)
        {
            if (CheckFile(image1Path) && CheckFile(image2Path))
            {
                ...
                return img1.PercentageDifference1(img2, threshold);
            }
            else return -1;
